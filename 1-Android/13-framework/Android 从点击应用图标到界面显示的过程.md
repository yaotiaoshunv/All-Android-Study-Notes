...
![img](https://upload-images.jianshu.io/upload_images/3985563-b7edc7b70c9c332f.png?imageMogr2/auto-orient/strip|imageView2/2/w/960/format/webp)

启动流程：

1. 点击桌面App图标，Launcher进程向system_server进程发起startActivity请求；
2. system_server进程接收到请求后，向Zygote进程发送创建进程的请求；
3. Zygote进程fork出新的子进程，即App进程；
4. App进程创建完成后会向system_server进程发起attachApplication请求；
5. system_server进程在收到请求后，进行一系列准备工作后，再通过binder IPC向App进程发送scheduleLaunchActivity请求；
6. App进程的binder（ApplicationThread）在收到请求后，通过handler向主线程发送LAUNCH_ACTIVITY消息；
7. 主线程在收到Message后，通过发射机制创建目标Activity，并回调Activity.onCreate()等方法。
8. 到此，App便正式启动，开始进入Activity的生命周期，执行完onCreate/onStart/onResume方法，UI渲染结束后便可以看到App的主界面。

上面的步骤介绍了一个APP从启动到主页面显示的整体过程（其中还有大量细节）。



Zygote fork的作用：实现资源共用和更快的启动速度
...
![img](https://upload-images.jianshu.io/upload_images/3985563-f9b3071c35cdb5de.png?imageMogr2/auto-orient/strip|imageView2/2/w/799/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/3985563-363b74b716570dd6.png?imageMogr2/auto-orient/strip|imageView2/2/w/799/format/webp)
...
关于Binder通信，可以参考这两篇文章理解一下：[简单理解Binder机制的原理](https://www.jianshu.com/p/4920c7781afe),[关于AIDL使用和Binder机制详解，你只需要看这一篇即可](https://www.jianshu.com/p/e3293b8346ab)。
...
![img](https://upload-images.jianshu.io/upload_images/3985563-25c23ee6ccb48048.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

**更直白的流程解释：**

![img](https://upload-images.jianshu.io/upload_images/3985563-ed91fd7c240e6bd3.png?imageMogr2/auto-orient/strip|imageView2/2/w/839/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/3985563-0eb6b9d2b091de3b.png?imageMogr2/auto-orient/strip|imageView2/2/w/1193/format/webp)

**更直白的流程解释：**

![img](https://upload-images.jianshu.io/upload_images/3985563-d8def9358f4646e1.png?imageMogr2/auto-orient/strip|imageView2/2/w/765/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/3985563-5222775558226c7d.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

**更直白的流程解释：**

![img](https://upload-images.jianshu.io/upload_images/3985563-5f711b4bca6bf21b.png?imageMogr2/auto-orient/strip|imageView2/2/w/896/format/webp)

### 四、Binder通信

![img](https://upload-images.jianshu.io/upload_images/3985563-cb3187996516846a.png?imageMogr2/auto-orient/strip|imageView2/2/w/807/format/webp)
